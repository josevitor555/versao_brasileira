...
const heroImages = [
  ...
  {
    url: 'https://images.unsplash.com/photo-1570890193787-9bd376f38a85?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1074',
    ...
    <section id="home" className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full text-center text-primary px-4">
        ...
        >
          ...
          <motion.h1 
            className="text-5xl md:text-7xl font-heading font-bold mb-6 drop-shadow-2xl text-light"
            variants={item}
          >
            Versão Brasileira
          </motion.h1>
        ...
        {heroImages.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all ${
              index === currentSlide ? 'bg-primary w-8' : 'bg-primary/50'
            }`}
          />
        ))}
      </div>
