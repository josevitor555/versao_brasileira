            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid lg:grid-cols-2 gap-24 max-w-6xl mx-auto">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-neutral-section p-6 rounded-lg text-start">
                        ...
                        {/* Social Media */}
                        <div className="bg-neutral-section p-6 rounded-lg">
                            ...
                            <div className="flex justify-center space-x-6">
                                {socialLinks.map((social, index) => (
                                    <a
                                        ...
                                        className={`flex items-center space-x-2 text-neutral-text-light ${social.color} transition-colors`}
                                    >
                                        {social.icon}
